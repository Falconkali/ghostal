...
file_path = "c:/Users/dell/OneDrive/Desktop/happy/src/app/(dashboard)/analytics/page.tsx"

with open(file_path, "r", encoding="utf-8") as f:
    lines = f.readlines()

new_content = """  // Live Metrics States
...
lines_to_keep_before = lines[:84]
lines_to_keep_after = lines[399:] # line 400 is `  // Export CSV Report completely client-side`
